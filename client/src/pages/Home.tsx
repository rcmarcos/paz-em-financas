...
export default function Home() {
  ...
  return <div className="site-shell">
    <header className="site-header"><a className="brand" href="#top" aria-label="Paz em Finanças"><img src="/manus-storage/paz-financas-veleiro-oficial_5dd7329c.jpg" alt="" className="brand-mark" /><span><strong>paz em</strong><em>finanças</em></span></a><button type="button" className="mobile-menu-button icon-button" onClick={() => setMobileMenuOpen((open) => !open)} aria-label="Abrir menu"><Menu size={20} /></button><nav className={`site-nav ${mobileMenuOpen ? "nav-open" : ""}`} aria-label="Navegação principal"><a href="#catalogo" onClick={() => setMobileMenuOpen(false)}>Explorar acervo</a><a href="#calculadora" onClick={() => setMobileMenuOpen(false)}>Calculadora</a><a href="#assistente" onClick={() => setMobileMenuOpen(false)}>Assistente</a><a href="#guias-praticos" onClick={() => setMobileMenuOpen(false)}>Guias práticos</a><a href="#como-funciona" onClick={() => setMobileMenuOpen(false)}>Como funciona</a><a href="#criterios" onClick={() => setMobileMenuOpen(false)}>Critérios</a><button type="button" className="header-compare" onClick={() => setComparisonOpen(true)} disabled={selectedEntries.length < 2}><span>{selectedEntries.length}</span> Comparar</button></nav></header>

    <main id="top">
      <section className="hero-section"><div className="hero-copy"><p className="overline"><span className="overline-dot" /> Guia prático e estoico</p><h1>Ajuste a vela, <em>aceite</em> o vento.</h1><p className="hero-lead">Uma curadoria de metodologias, modelos e ferramentas para organizar o dinheiro com clareza — sem jargão financeiro, sem julgamento, no seu ritmo.</p><div className="hero-actions"><button type="button" className="primary-button" onClick={scrollToCatalog}>Explorar o acervo <ArrowRight size={17} /></button><button type="button" className="primary-button button-selected" onClick={() => setAssistantOpen(true)}><Sparkles size={16} /> Encontrar meu método</button><button type="button" className="outline-button" onClick={exportPersonalReport}><Download size={16} /> Exportar meu plano</button></div><div className="hero-note"><Compass size={17} /><span><strong>{entries.length} fichas comparáveis</strong> baseadas na filosofia estoica, no minimalismo e no essencialismo.</span></div></div><div className="hero-art" aria-hidden="true"><div className="hero-image" style={{ backgroundImage: `url("/manus-storage/paz-financas-veleiro-oficial_5dd7329c.jpg")` }} /><div className="hero-stamp"><img src="/manus-storage/paz-financas-veleiro-oficial_5dd7329c.jpg" alt="" /><span>paz em<br />finanças</span></div><div className="hero-caption">01 / guia oficial</div></div></section>
      ...
      <section className="closing-section"><div className="closing-mark"><img src="/manus-storage/paz-financas-veleiro-oficial_5dd7329c.jpg" alt="" style={{ width: "64px", height: "64px", borderRadius: "50%", objectFit: "cover" }} /></div><p className="overline"><span className="overline-dot" /> Em construção contínua</p><h2>Uma boa decisão começa com uma boa pergunta.</h2><p>O acervo cresce com novas fichas, fontes e critérios. Use-o como ponto de partida para investigar — e confirme sempre os detalhes diretamente na fonte.</p><a className="source-link" href="https://www.bcb.gov.br/cidadaniafinanceira" target="_blank" rel="noreferrer">Conheça também a educação financeira do Banco Central <ExternalLink size={14} /></a></section>
    </main>

    <footer className="site-footer"><div className="footer-brand"><img src="/manus-storage/paz-financas-veleiro-oficial_5dd7329c.jpg" alt="" /><span><strong>paz em</strong><em>finanças</em></span></div><p>Guia prático para sair das dívidas e recomeçar com clareza — sem jargão, sem julgamento, no seu ritmo.</p><span className="footer-meta">Edição 01 · Filosofia estoica e minimalismo</span></footer>
